    ...
    public void create(Rol rol) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Usuario usuarioListUsuario : rol.getUsuarioList()) {
                Rol oldCodRolOfUsuarioListUsuario = usuarioListUsuario.getCodRol();
                usuarioListUsuario.setCodRol(rol);
                usuarioListUsuario = em.merge(usuarioListUsuario);
                if (oldCodRolOfUsuarioListUsuario != null) {
                    oldCodRolOfUsuarioListUsuario.getUsuarioList().remove(usuarioListUsuario);
                    oldCodRolOfUsuarioListUsuario = em.merge(oldCodRolOfUsuarioListUsuario);
                }
            }
            utx.commit();
        } catch (Exception ex) {
        ...
        try {
            ...
            for (Usuario usuarioListOldUsuario : usuarioListOld) {
                if (!usuarioListNew.contains(usuarioListOldUsuario)) {
                    ...
                    illegalOrphanMessages.add("You must retain Usuario " + usuarioListOldUsuario + " since its codRol field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Usuario usuarioListNewUsuario : usuarioListNew) {
                if (!usuarioListOld.contains(usuarioListNewUsuario)) {
                    Rol oldCodRolOfUsuarioListNewUsuario = usuarioListNewUsuario.getCodRol();
                    usuarioListNewUsuario.setCodRol(rol);
                    usuarioListNewUsuario = em.merge(usuarioListNewUsuario);
                    if (oldCodRolOfUsuarioListNewUsuario != null && !oldCodRolOfUsuarioListNewUsuario.equals(rol)) {
                        oldCodRolOfUsuarioListNewUsuario.getUsuarioList().remove(usuarioListNewUsuario);
                        oldCodRolOfUsuarioListNewUsuario = em.merge(oldCodRolOfUsuarioListNewUsuario);
                    }
                }
            }
            utx.commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Usuario usuarioListOrphanCheckUsuario : usuarioListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Rol (" + rol + ") cannot be destroyed since the Usuario " + usuarioListOrphanCheckUsuario + " in its usuarioList field has a non-nullable codRol field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
