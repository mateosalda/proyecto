...
import Bean.EstadoreservaFacade;
...
@Named("estadoreservaController")
@SessionScoped
public class EstadoreservaController implements Serializable {

    @EJB
    private Bean.EstadoreservaFacade ejbFacade;
    ...
    private EstadoreservaFacade getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("EstadoreservaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("EstadoreservaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("EstadoreservaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class EstadoreservaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            EstadoreservaController controller = (EstadoreservaController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "estadoreservaController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Estadoreserva) {
                ...
                return getStringKey(o.getCodestRes());
            } else {
